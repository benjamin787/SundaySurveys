...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, shouldUnregister = true, criteriaMode, } = {}) {
    ...
    const shallowFieldsStateRef = React.useRef(shouldUnregister ? {} : defaultValues);
    ...
    const handleSubmit = React.useCallback((onValid, onInvalid) => async (e) => {
        ...
        try {
            ...
            if (isEmptyObject(fieldErrors) &&
                Object.keys(formStateRef.current.errors).every((name) => Object.keys(fieldsRef.current).includes(name))) {
                updateFormState({
                    errors: {},
                    isSubmitting: true,
