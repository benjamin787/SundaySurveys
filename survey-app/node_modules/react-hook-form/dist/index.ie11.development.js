...
function useForm(_a) {
    ...
    var shallowFieldsStateRef = React.useRef(shouldUnregister ? {} : defaultValues);
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (isArray(payload)) {
                        ...
                        shouldRenderBaseOnError(payload, (error ? (_a = {}, _a[payload] = error, _a) : {}), previousFormIsValid !== isEmptyObject(errors), {}, isEmptyObject(errors));
                        return [2 /*return*/, !error];
                    }
            }
        });
    ...
    var setInternalValue = React.useCallback(function (name, value, config) {
        ...
        if (fieldsRef.current[name]) {
            ...
            if (isNameInFieldArray(fieldArrayNamesRef.current, name) ||
                ...
                resetFieldArrayFunctionRef.current[fieldArrayParentName]((_a = {},
                    _a[name] = value,
                    _a));
            }
        }
            ...
            switch (_e.label) {
                ...
                case 10:
                    if (!(isEmptyObject(fieldErrors) &&
                        Object.keys(formStateRef.current.errors).every(function (name) {
...
var useFieldArray = function (_a) {
    ...
    var append = function (value, shouldFocus) {
        ...
        if (readFormStateRef.current.dirtyFields ||
            readFormStateRef.current.isDirty) {
            set(dirtyFields, name, __spread(get(dirtyFields, name, fillEmptyArray(allFields.current)), filterBooleanArray(value)));
            updateFormState({
                isDirty: true,
                dirtyFields: dirtyFields,
            });
